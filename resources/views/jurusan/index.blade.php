...
<head>
  ...
  <title>Sistem Absensi - Data Jurusan</title>
              ...
              <table class="table table-bordered table-hover table-striped" id="datatable">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="/jurusan/edit/{{ $a->id }}" class="btn btn-secondary btn-icon-split btn-sm"><span class="icon text-white-50">
                          <i class="fas fa-edit"></i>
                        </span>
                        <span class="text">Edit</span>
                      </a>
                      <a href="/jurusan/hapus/{{ $a->id }}" class="btn btn-danger btn-icon-split btn-sm">
                        <span class="icon text-white-50">
