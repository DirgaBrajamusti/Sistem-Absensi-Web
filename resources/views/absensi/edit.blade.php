        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Edit Data Absensi</h1>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <form method="post" action="/absensi/update/{{ $absensi->id }}">
                            ...
                            <div class="form-group">
                                <label>NPM</label>
                                <input type="text" name="npm" class="form-control" placeholder="NPM..." value='{{$absensi->npm}}'>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="kelas_id">
                                    @foreach($kelas as $k)
                                    <option value=" {{ $k->id }} "@if ($k->id == $absensi->kelas_id) {{ 'selected' }} @endif>{{ $k->nama_kelas }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="mata_kuliah_id">
                                    ...
                                    <option value=" {{ $m->id }} " @if ($m->id == $absensi->mata_kuliah_id) {{ 'selected' }} @endif>{{ $m->nama_mata_kuliah }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                <label>Minggu</label>
                                <input type="text" name="minggu" class="form-control" placeholder="Minggu ke..." value='{{$absensi->minggu}}'>
                            ...
                            <div class="form-group">
                                <a href="/absensi" class="btn btn-primary btn-icon-split">
