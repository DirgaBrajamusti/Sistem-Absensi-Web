...
<head>
  ...
  <title>Sistem Absensi - Data Kelas</title>
              ...
              <table class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="/kelas/edit/{{ $a->id }}" class="btn btn-secondary btn-icon-split btn-sm">
                        <span class="icon text-white-50">
                          <i class="fas fa-edit"></i>
                        </span>
                        <span class="text">Edit</span>
                      </a>
                      <a href="/kelas/hapus/{{ $a->id }}" class="btn btn-danger btn-icon-split btn-sm">
                        <span class="icon text-white-50">
