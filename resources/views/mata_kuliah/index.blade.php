...
<body id="page-top">
              ...
              <table class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="/mata_kuliah/edit/{{ $a->id }}" class="btn btn-secondary btn-icon-split btn-sm"><span class="icon text-white-50">
                          <i class="fas fa-edit"></i>
                        </span>
                        <span class="text">Edit</span>
                      </a>
                      <a href="/mata_kuliah/hapus/{{ $a->id }}" class="btn btn-danger btn-icon-split btn-sm">
                        <span class="icon text-white-50">
  ...
  <div class="modal fade" id="addData" tabindex="-1" role="dialog" aria-labelledby="addDataModel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <form method="post" action="/mata_kuliah/store">
          <div class="modal-header">
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
              ...
              <input type="text" name="nama_mata_kuliah" class="form-control" placeholder="Nama mata kuliah...">
            ...
            <div class="form-group">
              ...
              <input type="time" name="jam_mulai" class="form-control" placeholder="Jam mulai (HH:MM:SS)...">
            ...
            <div class="form-group">
              ...
              <input type="time" name="jam_selesai" class="form-control" placeholder="Jam selesai (HH:MM:SS)...">
