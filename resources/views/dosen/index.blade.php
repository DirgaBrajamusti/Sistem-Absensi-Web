...
<head>
  ...
  <title>Sistem Absensi - Data Dosen</title>
...
<body id="page-top">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              <a class="btn btn-primary btn-icon-split" href="#" data-toggle="modal" data-target="#addData">
              ...
              <table class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      @foreach($a->mata_kuliah as $t)
                      {{$t->nama_mata_kuliah}},
                      @endforeach
                    </td>
                    <td>{{ $a->mata_kuliah->count() }}</td>
                    <td>
                      <a href="/dosen/edit/{{ $a->id }}" class="btn btn-secondary btn-icon-split btn-sm"><span class="icon text-white-50">
                          <i class="fas fa-edit"></i>
                        </span>
                        <span class="text">Edit</span>
                      </a>
                      <a href="/dosen/hapus/{{ $a->id }}" class="btn btn-danger btn-icon-split btn-sm">
                        <span class="icon text-white-50">
  ...
  <!-- Edit Modal Modal-->
  <div class="modal fade" id="editData" tabindex="-1" role="dialog" aria-labelledby="editDataModal" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <form method="post" action="/dosen/store">
          <div class="modal-header">
            <h5 class="modal-title" id="editDataModal">Tambah Data</h5>
            <button class="close" type="button" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">×</span>
            </button>
          </div>
